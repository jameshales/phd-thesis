...
By hypothesis there exists a unique $\kStateU \in \kStates$ such that $(\kStateU, \kStateT[x]) \in \refinement^x$.
From above we have that $(\kStateT, \kStateT[x]), (\kStateU, \kStateT[x]) \in \refinement^x$ and therefore $\kStateU = \kStateT$.
...
We claim for every $\gamma \in \Gamma_\agentA$ that $\kPModelP{\kStateSP_\gamma} \entails \gamma$ and for every $\kStateT \in \kSuccessorsA{\kStateS}$ that $\kPModelP{\kStateSP_{\kStateT}} \entails \bigvee_{\gamma \in \Gamma_\agentA}$.
