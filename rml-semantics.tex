...
Finally we remark on the sublogic relations that exist between refinement modal logics.
...
$\kPModelP{\kStateSP} \entails \somerefs (\possibleA \possibleA \atomP \land \lnot \possibleA \atomP)$ simply by removing the transitive $\agentA$-edges from $\kPModelP{\kStateS}$.
