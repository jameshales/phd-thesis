...
Bozzelli, et al.~\cite{bozzelli:2014a} have also shown that \logicRmlK{} is at least doubly exponentially more succinct than \logicK{}, which is interesting because, at least in the single-agent variant, the satisfiability problem for \logicRmlK{} is only singly exponentially harder than the satisfability problem for \logicK{}. 
