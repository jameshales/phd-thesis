...
We call an $\{\agentA\}$-restricted formula simply an {\em $\agentA$-restricted formula}.

\todo[inline]{$\agentsB$-restricted bisimulation}
...
As $\gamma$ is a $\agents \setminus \{\agentA\}$-restricted formula and $\kPModel[\gamma]{\kStateS[\gamma]} \entails \gamma$ then we have that $\kPModelP{\kStateSP_\gamma} \entails \gamma$.
Then $\kPModelP{\kStateSP} \entails \coversA \Gamma_\agentA$ follows from the same reasoning as in the proof of soundness of {\bf RK} in Lemma~\ref{rml-k-rk}.
Therefore $\kPModel{\kStateS} \entails \somerefsBs \coversA \Gamma_\agentA$.
\end{proof}
