...
Let $\kPModel$ and $\kPModelP$ be pointed Kripke models such that $\kPModel \bisimilar \kPModelP$ and
let $\aPModel$ and $\aPModelP$ be pointed action models such that $\aPModel \bisimilar \aPModelP$.
Then $\kPModel \exec \aPModel \bisimilar \kPModelP \exec \aPModelP$.
\end{proposition}
