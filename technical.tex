...
In Section~\ref{mu} we introduce the modal $\mu$-calculus, which is used as a point of comparison for the expressivity of the transitive refinement modal logic in Chapter~\ref{rml}.
