...
As in the previous chapter where we considered \logicRmlK{}, in this chapter we present all of the same results for \logicRmlKFF{} and \logicRmlKD{}, including sound and complete axiomatisations, provably correct translations from \langRml{} to \langMl{}, and expressive equivalence, compactness and decidability results.
As noted in Chapter~\ref{rml}, the logic \logicRmlK{} is not a sublogic of \logicRmlKFF{} or \logicRmlKD{}.
In particular, the key axioms {\bf RK}, {\bf RComm}, and {\bf RDist} from \axiomRmlK{} are not sound in \logicRmlKFF{} or \logicRmlKD{}, so we must find replacement axioms.

In the following sections we provide axiomatisations for \logicRmlKFF{} and \logicRmlKD{}, and show that they are sound and complete with respect to the semantics of \logicRmlKFF{} and \logicRmlKD{}.
In Section~\ref{rml-kd45-axiomatisation} we provide the axiomatisations for \logicRmlKFF{} and \logicRmlKD{}, that are versions of the axiomatisation of \logicRmlK{} with additional syntactic restrictions.
In Section~\ref{rml-kd45-soundness} we show that the axiomatisations are sound, using constructive proofs.
