...
\begin{figure}
    \caption{A schematic of the construction used to show soundness of {\bf RK45}.}\label{rml-kff-rkff-construction}
    \centering
...
\begin{figure}
    \caption{A schematic of the construction used to show soundness of {\bf RComm}.}\label{rml-kff-rcomm-construction}
    \centering
    \begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node distance=7em,thick]
...
\begin{lemma}\label{rml-kd-ml-equivalent}
Every refinement modal formula is provably equivalent to a modal formula using the axiomatisation \axiomRmlKFF{}.
\end{lemma}
