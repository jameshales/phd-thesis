...
\todo[inline]{Rewrite proof to match new definition of explicit formulas}
...
We show that $\chi'$ is an explicit formula.
...
\todo[inline]{Example of conversion to explicit formulas}
