...
\begin{proposition}
    Let $\kModel \in \classKFF$ and $\aModel \in \classKFF$. Then $\kModel \exec \aModel \in \classKFF$.
\end{proposition}

\begin{proposition}
    Let $\kModel \in \classS$ and $\aModel \in \classS$. Then $\kModel \exec \aModel \in \classS$.
\end{proposition}
...
Then for every $\phi \in \langAml$: $\kPModel{\kStateS} \entails \actionA{\aPModel{\aStateS}} \phi$ if and only if $\kPModelP{\kStateSP} \entails \actionA{\aPModel{\aStateS}} \phi$.
\end{proposition}
