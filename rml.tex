...
\begin{proof}
($\Rightarrow$) Let $\kPModel{\kStateS} \in \classK$ be a Kripke model such that $\kPModel{\kStateS} \entails \somerefsBs \coversA \Gamma_\agentA$.
...
($\Leftarrow$) Let $\kPModel{\kStateS} \in \classK$ be a Kripke model such that $\kPModel{\kStateS} \entails \bigwedge_{\gamma \in \Gamma_\agentA} \possibleA \somerefsBs \gamma$.
...
Consider $(\kStateT, \kStateTP) \in \refinement$ where $(\kStateT, \kStateTP) \in \refinement^\gamma$ for some $\gamma \in \Gamma_\agentA$.
...
($\Leftarrow$) Let $\kPModel{\kStateS} \in \classK$ be a Kripke model such that $\kPModel{\kStateS} \entails \coversA \{\somerefsBs \gamma \mid \gamma \in \Gamma_\agentA\}$.
For every $\gamma \in \Gamma_\agentA$ there exists $\kStateT_\gamma \in \kSuccessorsA{\kStateS}$ and $\kPModelAndTuple[\gamma]{\kStateS[\gamma]} \in \classK$ such that $\kPModel{\kStateT_\gamma} \simulatesBs \kPModel[\gamma]{\kStateS[\gamma]}$ and $\kPModel[\gamma]{\kStateS[\gamma]} \entails \gamma$.
...
Consider $(\kStateT, \kStateTP) \in \refinement$ where $(\kStateT, \kStateTP) \in \refinement^\gamma$ for some $\gamma \in \Gamma_\agentA$ or $(\kStateT, \kStateTP) \in \refinement^{\kStateT}$ for some $\kStateT \in \kSuccessorsA{\kStateS}$.
...
Then by hypothesis $\kStateT \in \kSuccessorsA{\kStateS}$ and $\kStateT \refinement \kStateS[\kStateT]$.
Suppose that $\agentB \neq \agentA$.
Let $\kStateT \in \kSuccessorsPB{\kStateSP}$.
By construction $\kStateT \in \kSuccessorsB{\kStateS}$ and $\kStateT \refinement \kStateT$.
...
($\Leftarrow$) Let $\kPModel{\kStateS} \in \classK$ be a Kripke model such that $\kPModel{\kStateS} \entails \bigwedge_{\agentC \in \agentsC} \somerefsBs \coversC \Gamma_\agentC$.
...
\todo[inline]{Diagram of {\bf RDist} construction.}
...
\begin{definition}[$\agentsB$-restricted formulas]
Let $\agentsB \subseteq \agents$.
A $\agentsB$-restricted formula is inductively defined as:
$$
\phi ::= \atomP \mid
         \lnot \phi \mid
         \phi \land \phi \mid
...
Let $\agentsB \subseteq \agents$ and let $\kPModelAndTuple{\kStateS}$ and $\kPModelAndTupleP{\kStateSP}$ be pointed Kripke models.
...
Let $\agentsB \subseteq \agents$ and let $\kPModel{\kStateS}$ and $\kPModelP{\kStateSP}$ be pointed Kripke models such that $\kPModel{\kStateS} \bisimilar[\agentsB] \kPModelP{\kStateSP}$.
Then for every $\agentsB$-restricted formula $\phi \in \langMl$:
$\kPModel{\kStateS} \entails \phi$ if and only if $\kPModelP{\kStateSP} \entails \phi$.
\end{lemma}

\begin{proof}
Let $\phi \in \langMl$ be a $\agentsB$-restricted formula.
...
Suppose that $\phi = \lnot \psi$ or $\phi = \psi \land \chi$ for $\agentsB$-restricted formulas $\psi, \chi \in \langMl$.
These follow directly from the induction hypothesis.
...
\end{array}
$$
where for every $\agentA \in \agents$, $\Gamma_\agentA$ is a non-empty, finite set of $(\agents \setminus \{\agentA\})$-restricted formulas.
\end{definition}
...
($\Leftarrow$) Let $\kPModel{\kStateS} \in \classKD$ be a Kripke model such that $\kPModel{\kStateS} \entails \bigwedge_{\gamma \in \Gamma_\agentA} \possibleA \somerefsBs \gamma$.
...
\begin{eqnarray*}
    ...
    \kAccessibilityPB &=& \{(\kStateSP, \kStateT) \mid \kStateT \in \kSuccessorsB{\kStateS}\} \cup \{(\kStateSP_\gamma, \kStateT[\gamma]) \mid \kStateT[\gamma] \in \kSuccessorsB[\gamma]{\kStateS[\gamma]}\} \cup \kAccessibilityB \cup \bigcup_{\gamma \in \Gamma_\agentA} \kAccessibilityB[\gamma] \text{ for } \agentB \in \agents \setminus \{\agentA\}\\
...
We note that by construction $\kPModelP \in \classKD$.
...
By construction $\kStateT_\gamma \refinement^\gamma \kStateS[\gamma]$.
...
As $\agentC \in \agents \setminus \agentsB$ and $\agentA \in \agentsB$ then $\agentC \neq \agentA$.
By construction $\kStateT_\gamma \refinement^\gamma \kStateS[\gamma]$.
By {\bf forth-$\agentC$} for $\refinement^\gamma$ there exists $\kStateU[\gamma] \in \kSuccessorsC[\gamma]{\kStateS[\gamma]}$ such that $\kStateU \refinement^\gamma \kStateU[\gamma]$.
By construction $\kStateU[\gamma] \in \kSuccessorsPC{\kStateSP_\gamma}$ and $\kStateU \refinement \kStateU[\gamma]$.
...
Then by hypothesis $\kStateT_\gamma \in \kSuccessorsA{\kStateS}$ and $\kStateT_\gamma \refinement \kStateSP_\gamma$.
Let $\kStateSP_{\kStateT} \in \kSuccessorsPA{\kStateSP}$ where $\kStateT \in \kSuccessorsA{\kStateS}$.
Then by hypothesis $\kStateT \in \kSuccessorsA{\kStateS}$ and $\kStateT \refinement \kStateSP_{\kStateT}$.
Suppose that $\agentB \neq \agentA$.
Let $\kStateT \in \kSuccessorsPB{\kStateSP}$.
By construction $\kStateT \in \kSuccessorsB{\kStateS}$ and $\kStateT \refinement \kStateT$.
...
By hypothesis $\kStateT_{\gamma}, \kStateT_{\gamma'} \in \kSuccessorsA{\kStateS}$, and $\kStateT_{\gamma'} \refinement^{\gamma'} \kStateS[\gamma']$.
As $\kModel \in \classKD$ by the Euclideaness of $\kAccessibilityA$ we have that $\kStateT_{\gamma'} \in \kSuccessorsA{\kStateT_\gamma}$.
By construction $\kStateT_{\gamma'} \refinement \kStateSP_{\gamma'}$.
Suppose that $\agentB \neq \agentA$.
Let $\kStateT[\gamma] \in \kSuccessorsPA{\kStateSP_\gamma}$.
By construction $\kStateT_\gamma \refinement^\gamma \kStateS[\gamma]$.
By {\bf back-$\agentB$} for $\refinement^\gamma$ there exists $\kStateU \in \kSuccessorsB{\kStateT_\gamma}$ such that $\kStateU \refinement^\gamma \kStateT[\gamma]$.
By construction $\kStateU \refinement \kStateT[\gamma]$.
...
As $\gamma$ is a $(\agents \setminus \{\agentA\})$-restricted formula and $\kPModel[\gamma]{\kStateS[\gamma]} \entails \gamma$ then by Lemma~\ref{b-restricted-invariance} we have that $\kPModelP{\kStateSP_\gamma} \entails \gamma$.
Then $\kPModelP{\kStateSP} \entails \coversA \Gamma_\agentA$ follows from the same reasoning as in the proof of soundness of {\bf RK} in Lemma~\ref{rml-k-rk}.
Therefore $\kPModel{\kStateS} \entails \somerefsBs \coversA \Gamma_\agentA$.
\end{proof}
...
($\Leftarrow$) Let $\kPModel{\kStateS} \in \classKD$ be a Kripke model such that $\kPModel{\kStateS} \entails \coversA \{\somerefsBs \gamma \mid \gamma \in \Gamma_\agentA\}$.
For every $\gamma \in \Gamma_\agentA$ there exists $\kStateT_\gamma \in \kSuccessorsA{\kStateS}$ and $\kPModelAndTuple[\gamma]{\kStateS[\gamma]} \in \classKD$ such that $\kPModel{\kStateT_\gamma} \simulatesBs \kPModel[\gamma]{\kStateS[\gamma]}$ and $\kPModel[\gamma]{\kStateS[\gamma]} \entails \gamma$.
...
By construction $\kStateT \refinement^{\kStateT} \kStateS[\kStateT]$.
...
Consider $(\kStateT_\gamma, \kStateSP_\gamma) \in \refinement$ where $\gamma \in \Gamma_\agentA$.
Suppose that $\agentC = \agentA$.
Let $\kStateT \in \kSuccessorsA{\kStateT_\gamma}$.
By hypothesis $\kStateT, \kStateT_\gamma \in \kSuccessorsA{\kStateS}$ and $\kStateT \refinement^{\kStateT} \kStateS[\kStateT]$.
By construction $\kStateSP_{\kStateT} \in \kSuccessorsPA{\kStateSP_\gamma}$ and $\kStateT \refinement \kStateSP_{\kStateT}$.
Suppose that $\agentC \neq \agentA$.
Let $\kStateU \in \kSuccessorsC{\kStateT_\gamma}$.
By construction $\kStateT_\gamma \refinement^\gamma \kStateS[\gamma]$.
By {\bf forth-$\agentC$} for $\refinement^\gamma$ there exists $\kStateU[\gamma] \in \kSuccessorsC[\gamma]{\kStateS[\gamma]}$ such that $\kStateU \refinement^\gamma \kStateU[\gamma]$.
...
By hypothesis $\kStateT, \kStateU \in \kSuccessorsA{\kStateS}$ and $\kStateU \refinement^{\kStateU} \kStateS[\kStateU]$.
By construction $\kStateSP_{\kStateU} \in \kSuccessorsPA{\kStateSP_{\kStateU}}$ and $\kStateU \refinement \kStateSP_{\kStateU}$.
Suppose that $\agentC \neq \agentA$.
Let $\kStateU \in \kSuccessorsC{\kStateT}$.
By construction $\kStateU \refinement^{\kStateU} \kStateS[\kStateU]$.
By {\bf forth-$\agentC$} for $\refinement^{\kStateU}$ there exists $\kStateT[\kStateU] \in \kSuccessorsC[\kStateU]{\kStateS[\kStateU]}$ such that $\kStateU \refinement^{\kStateU} \kStateT[\kStateU]$.
By construction $\kStateT[\kStateU] \in \kSuccessorsPC{\kStateSP_{\kStateT}}$ and $\kStateU \refinement \kStateT[\kStateU]$.
...
By hypothesis $\kStateT, \kStateT_{\gamma} \in \kSuccessorsA{\kStateS}$, and $\kStateT \refinement^{\kStateT} \kStateS[\kStateT]$.
As $\kModel \in \classKD$ by the Euclideaness of $\kAccessibilityA$ we have that $\kStateT_{\gamma'} \in \kSuccessorsA{\kStateT_\gamma}$.
By construction $\kStateT \refinement \kStateSP_{\kStateT}$.
Suppose that $\agentB \neq \agentA$.
Let $\kStateT[\gamma] \in \kSuccessorsPA{\kStateSP_\gamma}$.
By construction $\kStateT_\gamma \refinement^\gamma \kStateS[\gamma]$.
By {\bf back-$\agentB$} for $\refinement^\gamma$ there exists $\kStateU \in \kSuccessorsB{\kStateT_\gamma}$ such that $\kStateU \refinement^\gamma \kStateT[\gamma]$.
...
By hypothesis $\kStateT, \kStateT_{\gamma} \in \kSuccessorsA{\kStateS}$, and $\kStateT_{\gamma} \refinement^\gamma \kStateS[\gamma]$.
As $\kModel \in \classKD$ by the Euclideaness of $\kAccessibilityA$ we have that $\kStateT_{\gamma} \in \kSuccessorsA{\kStateT}$.
By construction $\kStateT_{\gamma} \refinement \kStateSP_{\gamma}$.
Let $\kStateSP_{\kStateU} \in \kSuccessorsPA{\kStateSP_{\kStateT}}$ where $\kStateU \in \kSuccessorsA{\kStateS}$.
By hypothesis $\kStateT, \kStateU \in \kSuccessorsA{\kStateS}$, and $\kStateU \refinement^{\kStateU} \kStateS[\kStateU]$.
As $\kModel \in \classKD$ by the Euclideaness of $\kAccessibilityA$ we have that $\kStateU \in \kSuccessorsA{\kStateT}$.
By construction $\kStateU \refinement \kStateSP_{\kStateU}$.
Suppose that $\agentB \neq \agentA$.
Let $\kStateU[\kStateT] \in \kSuccessorsPA{\kStateSP_{\kStateT}}$.
By construction $\kStateT \refinement^{\kStateT} \kStateS[\kStateT]$.
By {\bf back-$\agentB$} for $\refinement^{\kStateT}$ there exists $\kStateU \in \kSuccessorsB{\kStateT}$ such that $\kStateU \refinement^{\kStateT} \kStateU[\kStateT]$.
By construction $\kStateU \refinement \kStateU[\kStateT]$.
...
($\Leftarrow$) Let $\kPModel{\kStateS} \in \classKD$ be a Kripke model such that $\kPModel{\kStateS} \entails \bigwedge_{\agentC \in \agentsC} \somerefsBs \coversC \Gamma_\agentC$.
