...
We note that the translation used in the proof of Lemma~\ref{dnf-equivalent} does not introduce modalities from agents not already appearing in the formula, and so translating a $\agentsB$-restricted modal formula into disjunctive normal form will result in a $\agentsB$-restricted modal formula.
