...
In contrast to the logics \logicRmlK{}, \logicRmlKFF{}, \logicRmlKD{}, and \logicRmlS{}, which we axiomatised in previous chapters, \logicRmlK{} is not expressively equivalent to the underlying modal logic \logicKF{}, so we must use a different strategy to show that a candidate axiomatisation is complete.
Work on this problem is on-going.
The main results of this chapter are expressivity results.
We show that the logic \logicRmlKF{} is strictly more expressive than the underlying modal logic \logicKF{}, and strictly less expressive than the modal $\mu$-calculus \logicMuKF{}, the bisimulation quantified modal logic \logicBqmlKF{}, and the tangled modal logic \logicTangleKF{}.
