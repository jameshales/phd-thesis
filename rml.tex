...
By hypothesis $\kStateT_{\gamma}, \kStateT_{\gamma'} \in \kSuccessorsA{\kStateS}$, and $(\kStateT_{\gamma'}, \kStateS[\gamma']) \in \refinement^{\gamma'}$.
...
By hypothesis $\kStateT, \kStateT_\gamma \in \kSuccessorsA{\kStateS}$ and $(\kStateT, \kStateS[\kStateT]) \in \refinement^{\kStateT}$.
By construction $\kStateSP_{\kStateT} \in \kSuccessorsPA{\kStateSP_\gamma}$ and $(\kStateT, \kStateSP_{\kStateT}) \in \refinement$.
Suppose that $\agentC \neq \agentA$.
Let $\kStateU \in \kSuccessorsC{\kStateT_\gamma}$.
By construction $(\kStateT_\gamma, \kStateS[\gamma]) \in \refinement^\gamma$.
By {\bf forth-$\agentC$} for $\refinement^\gamma$ there exists $\kStateU[\gamma] \in \kSuccessorsC[\gamma]{\kStateS[\gamma]}$ such that $(\kStateU, \kStateU[\gamma]) \in \refinement^\gamma$.
...
By hypothesis $\kStateT, \kStateU \in \kSuccessorsA{\kStateS}$ and $(\kStateU, \kStateS[\kStateU]) \in \refinement^{\kStateU}$.
...
By hypothesis $\kStateT, \kStateT_{\gamma} \in \kSuccessorsA{\kStateS}$, and $(\kStateT_{\gamma}, \kStateS[\gamma]) \in \refinement^\gamma$.
