...
In Section~\ref{pal} we introduce public announcement logic, which will be used only in Chapter~\ref{papal} on arbitrary positive announcement logic. 
...
Bisimilar action models have bisimilar results.
...
We have similar depth-limited results for $n$-bisimilarity.
