...
The result of publicly announcing that a formula $\phi$ is true in an initial Kripke model $\kModel$ is represented by the model restriction $\restrict{\kModel}{\phi}$ of $\kModel$ to the states where $\phi$ was true in $\kModel$.
...
We also restate some results about the \logicPalS{} and its proof theory.
