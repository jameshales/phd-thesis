...
\begin{example}
\begin{figure}
    \caption{An example of two Kripke models that are refinements of each other.}\label{example-aaml-figure}
    \centering
...
\begin{example}
\begin{figure}
    \caption{An example of a Kripke model and refinement.}\label{example-aaml-2-figure}
    \centering
    \begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node distance=7em,thick]
